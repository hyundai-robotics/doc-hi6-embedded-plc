...
* [3. Relays](3-relay/README.md)
  ...
  * [3.3 Input/Output](3-relay/3-io/README.md)
    * [3.3.1 SO - System output (Hi6)](3-relay/3-io/1-so.md)
    * [3.3.2 SI - System input (Hi6)](3-relay/3-io/2-si.md)
    * [3.3.3 SO - System output (Hi7)](3-relay/3-io/3-so-hi7.md)
    * [3.3.4 SI - System input (Hi7)](3-relay/3-io/4-si-hi7.md)
    * [3.3.5 Safety output (Hi7)](3-relay/3-io/5-safety-out-hi7.md)
    * [3.3.6 Safety input (Hi7)](3-relay/3-io/6-safety-in-hi7.md)
    * [3.3.7 Safety Communication output (Hi7)](3-relay/3-io/7-safety-comm-out.md)
    * [3.3.8 Safety Communication input (Hi7)](3-relay/3-io/8-safety-comm-in.md)
  * [3.4 S relays](3-relay/4-sw-relay/README.md)
    ...
    * [3.4.10 S Relay - ARCWELD_INFO](3-relay/4-sw-relay/10-slot-arcweld-info.md)
    ...
    * [3.4.14 S Relay - CIFX PCI Communication](3-relay/4-sw-relay/14-slot-cifx-info/README.md)
      ...
      * [3.4.14.4 DeviceNet Master Status](3-relay/4-sw-relay/14-slot-cifx-info/4-slot-devicenet-info.md)
      * [3.4.14.5 EtherNet/IP Master Status](3-relay/4-sw-relay/14-slot-cifx-info/5-slot-ethernet-ip-info.md)
      * [3.4.14.6 Profinet IO Master Status](3-relay/4-sw-relay/14-slot-cifx-info/6-slot-profinet-io-info.md)
      * [3.4.14.7 EtherCAT Master Status](3-relay/4-sw-relay/14-slot-cifx-info/7-slot-ethercat-info.md)
