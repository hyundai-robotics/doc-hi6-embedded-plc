...
자세한 내용은 [${cont_model} 조작설명서 - 6. 모니터링](https://hrbook-hrc.web.app/#/view/doc-hi6-operation/ko-tp630/6-monitoring/README?cont_model=${cont_model}) 절을 참조하십시오.
...
자세한 내용은 [${cont_model} 조작설명서 - 입출력 신호 설정](https://hrbook-hrc.web.app/#/view/doc-hi6-operation/ko-tp630/7-system/3-control-parameter/2-io-signal-setting/README?cont_model=${cont_model}) 절을 참조하십시오.
...
### 외부 통신 연결
Hilscher CIF card들은 물리적 입출력 I/O와 연결됩니다. 1개 혹은 여러 개의 FB객체를 특정한 CIF card 매핑하는 방법은 [${cont_model} 조작설명서 - 입출력 신호 설정 - DIO 블록 할당](https://hrbook-hrc.web.app/#/view/doc-hi6-operation/ko-tp630/7-system/3-control-parameter/2-io-signal-setting/9-dio-block-assign?cont_model=${cont_model})를 참고하십시오.
...
<tbody>
	...
	<tr>
		<td>so161</td>
		<td>ch1- 통신방식 (0=라인드라이브, 1=오픈콜렉터)</td>
	</tr>
	<tr>
		<td>so162</td>
		<td>ch2 - 펄스 카운팅 타입 (0=up, 1=up/down)</td>
	</tr>
	<tr>
		<td>so163</td>
...
<tbody>
	<tr>
		<td rowspan=15>BD642<br>시스템 출력</td>
		<td rowspan=4>sob0</td>
		<td>so0</td>
		<td>모터 ON(TP)</td>
	</tr>
...
<tbody>
	<tr>
		<td rowspan=1>BD642<br>기본안전출력</td>
...
<tbody>
	<tr>
		<td rowspan=8>BD680<br>부가안전출력</td>
...
<tbody>
    <!-- sob64 -->
    <tr>
        <td rowspan="64">안전통신출력</td>
        <td rowspan="8">sob64</td>
        <td>so512</td>
        <td>안전통신출력 0</td>
    </tr>
    <tr><td>so513</td><td>안전통신출력 1</td></tr>
    <tr><td>so514</td><td>안전통신출력 2</td></tr>
    <tr><td>so515</td><td>안전통신출력 3</td></tr>
    <tr><td>so516</td><td>안전통신출력 4</td></tr>
    <tr><td>so517</td><td>안전통신출력 5</td></tr>
    <tr><td>so518</td><td>안전통신출력 6</td></tr>
    <tr><td>so519</td><td>안전통신출력 7</td></tr>
    <!-- sob65 -->
    <tr>
    ...
    <tr><td>so521</td><td>안전통신출력 9</td></tr>
    <tr><td>so522</td><td>안전통신출력 10</td></tr>
    <tr><td>so523</td><td>안전통신출력 11</td></tr>
    <tr><td>so524</td><td>안전통신출력 12</td></tr>
    <tr><td>so525</td><td>안전통신출력 13</td></tr>
    <tr><td>so526</td><td>안전통신출력 14</td></tr>
    <tr><td>so527</td><td>안전통신출력 15</td></tr>
    <!-- sob66 -->
    <tr>
    ...
    <tr><td>so529</td><td>안전통신출력 17</td></tr>
    <tr><td>so530</td><td>안전통신출력 18</td></tr>
    <tr><td>so531</td><td>안전통신출력 19</td></tr>
    <tr><td>so532</td><td>안전통신출력 20</td></tr>
    <tr><td>so533</td><td>안전통신출력 21</td></tr>
    <tr><td>so534</td><td>안전통신출력 22</td></tr>
    <tr><td>so535</td><td>안전통신출력 23</td></tr>
    <!-- sob67 -->
    <tr>
    ...
    <tr><td>so537</td><td>안전통신출력 25</td></tr>
    <tr><td>so538</td><td>안전통신출력 26</td></tr>
    <tr><td>so539</td><td>안전통신출력 27</td></tr>
    <tr><td>so540</td><td>안전통신출력 28</td></tr>
    <tr><td>so541</td><td>안전통신출력 29</td></tr>
    <tr><td>so542</td><td>안전통신출력 30</td></tr>
    <tr><td>so543</td><td>안전통신출력 31</td></tr>
    <!-- sob68 -->
    <tr>
    ...
    <tr><td>so545</td><td>안전통신출력 33</td></tr>
    <tr><td>so546</td><td>안전통신출력 34</td></tr>
    <tr><td>so547</td><td>안전통신출력 35</td></tr>
    <tr><td>so548</td><td>안전통신출력 36</td></tr>
    <tr><td>so549</td><td>안전통신출력 37</td></tr>
    <tr><td>so550</td><td>안전통신출력 38</td></tr>
    <tr><td>so551</td><td>안전통신출력 39</td></tr>
    <!-- sob69 -->
    <tr>
    ...
    <tr><td>so553</td><td>안전통신출력 41</td></tr>
    <tr><td>so554</td><td>안전통신출력 42</td></tr>
    <tr><td>so555</td><td>안전통신출력 43</td></tr>
    <tr><td>so556</td><td>안전통신출력 44</td></tr>
    <tr><td>so557</td><td>안전통신출력 45</td></tr>
    <tr><td>so558</td><td>안전통신출력 46</td></tr>
    <tr><td>so559</td><td>안전통신출력 47</td></tr>
    <!-- sob70 -->
    <tr>
    ...
    <tr><td>so561</td><td>안전통신출력 49</td></tr>
    <tr><td>so562</td><td>안전통신출력 50</td></tr>
    <tr><td>so563</td><td>안전통신출력 51</td></tr>
    <tr><td>so564</td><td>안전통신출력 52</td></tr>
    <tr><td>so565</td><td>안전통신출력 53</td></tr>
    <tr><td>so566</td><td>안전통신출력 54</td></tr>
    <tr><td>so567</td><td>안전통신출력 55</td></tr>
    <!-- sob71 -->
    <tr>
    ...
    <tr><td>so569</td><td>안전통신출력 57</td></tr>
    <tr><td>so570</td><td>안전통신출력 58</td></tr>
    <tr><td>so571</td><td>안전통신출력 59</td></tr>
    <tr><td>so572</td><td>안전통신출력 60</td></tr>
    <tr><td>so573</td><td>안전통신출력 61</td></tr>
    <tr><td>so574</td><td>안전통신출력 62</td></tr>
    <tr><td>so575</td><td>안전통신출력 63</td></tr>
</tbody>
...
<tbody>
	<tr>
		<td rowspan=32>BD642<br>시스템 입력</td>
		<td rowspan=8>sib0</td>
		<td>si0</td>
		<td>승강축/암 리밋</td>
	</tr>
...
<tbody>
	<tr>
		<td rowspan=32>BD682<br>컨베이어</td>
		<td rowspan=1>sib42<br>sib43</td>
		<td></td>
		<td>ch1 - 펄스 카운터<br>(16bit)</td>
	</tr>
...
<tbody>
	<tr>
		<td rowspan=4>BD642<br>기본안전입력</td>
		<td rowspan=4>sib56</td>
		<td>si448</td>
		<td>기본안전입력 0</td>
	</tr>
	<tr><td>si449</td><td>기본안전입력 1</td></tr>
	<tr><td>si450</td><td>기본안전입력 2</td></tr>
	<tr><td>si451</td><td>기본안전입력 3</td></tr>
</tbody>

<tbody>
	<tr>
		<td rowspan=8>BD680<br>부가안전입력</td>
...
<tbody>
    <!-- sib64 -->
    <tr>
        <td rowspan="64">안전통신입력</td>
        <td rowspan="8">sib64</td>
        <td>si512</td>
        <td>안전통신입력 0</td>
    </tr>
    <tr><td>si513</td><td>안전통신입력 1</td></tr>
    <tr><td>si514</td><td>안전통신입력 2</td></tr>
    <tr><td>si515</td><td>안전통신입력 3</td></tr>
    <tr><td>si516</td><td>안전통신입력 4</td></tr>
    <tr><td>si517</td><td>안전통신입력 5</td></tr>
    <tr><td>si518</td><td>안전통신입력 6</td></tr>
    <tr><td>si519</td><td>안전통신입력 7</td></tr>
    <!-- sib65 -->
    <tr>
    ...
    <tr><td>si521</td><td>안전통신입력 9</td></tr>
    <tr><td>si522</td><td>안전통신입력 10</td></tr>
    <tr><td>si523</td><td>안전통신입력 11</td></tr>
    <tr><td>si524</td><td>안전통신입력 12</td></tr>
    <tr><td>si525</td><td>안전통신입력 13</td></tr>
    <tr><td>si526</td><td>안전통신입력 14</td></tr>
    <tr><td>si527</td><td>안전통신입력 15</td></tr>
    <!-- sib66 -->
    <tr>
    ...
    <tr><td>si529</td><td>안전통신입력 17</td></tr>
    <tr><td>si530</td><td>안전통신입력 18</td></tr>
    <tr><td>si531</td><td>안전통신입력 19</td></tr>
    <tr><td>si532</td><td>안전통신입력 20</td></tr>
    <tr><td>si533</td><td>안전통신입력 21</td></tr>
    <tr><td>si534</td><td>안전통신입력 22</td></tr>
    <tr><td>si535</td><td>안전통신입력 23</td></tr>
    <!-- sib67 -->
    <tr>
    ...
    <tr><td>si537</td><td>안전통신입력 25</td></tr>
    <tr><td>si538</td><td>안전통신입력 26</td></tr>
    <tr><td>si539</td><td>안전통신입력 27</td></tr>
    <tr><td>si540</td><td>안전통신입력 28</td></tr>
    <tr><td>si541</td><td>안전통신입력 29</td></tr>
    <tr><td>si542</td><td>안전통신입력 30</td></tr>
    <tr><td>si543</td><td>안전통신입력 31</td></tr>
    <!-- sib68 -->
    <tr>
    ...
    <tr><td>si545</td><td>안전통신입력 33</td></tr>
    <tr><td>si546</td><td>안전통신입력 34</td></tr>
    <tr><td>si547</td><td>안전통신입력 35</td></tr>
    <tr><td>si548</td><td>안전통신입력 36</td></tr>
    <tr><td>si549</td><td>안전통신입력 37</td></tr>
    <tr><td>si550</td><td>안전통신입력 38</td></tr>
    <tr><td>si551</td><td>안전통신입력 39</td></tr>
    <!-- sib69 -->
    <tr>
    ...
    <tr><td>si553</td><td>안전통신입력 41</td></tr>
    <tr><td>si554</td><td>안전통신입력 42</td></tr>
    <tr><td>si555</td><td>안전통신입력 43</td></tr>
    <tr><td>si556</td><td>안전통신입력 44</td></tr>
    <tr><td>si557</td><td>안전통신입력 45</td></tr>
    <tr><td>si558</td><td>안전통신입력 46</td></tr>
    <tr><td>si559</td><td>안전통신입력 47</td></tr>
    <!-- sib70 -->
    <tr>
    ...
    <tr><td>si561</td><td>안전통신입력 49</td></tr>
    <tr><td>si562</td><td>안전통신입력 50</td></tr>
    <tr><td>si563</td><td>안전통신입력 51</td></tr>
    <tr><td>si564</td><td>안전통신입력 52</td></tr>
    <tr><td>si565</td><td>안전통신입력 53</td></tr>
    <tr><td>si566</td><td>안전통신입력 54</td></tr>
    <tr><td>si567</td><td>안전통신입력 55</td></tr>
    <!-- sib71 -->
    <tr>
    ...
    <tr><td>si569</td><td>안전통신입력 57</td></tr>
    <tr><td>si570</td><td>안전통신입력 58</td></tr>
    <tr><td>si571</td><td>안전통신입력 59</td></tr>
    <tr><td>si572</td><td>안전통신입력 60</td></tr>
    <tr><td>si573</td><td>안전통신입력 61</td></tr>
    <tr><td>si574</td><td>안전통신입력 62</td></tr>
    <tr><td>si575</td><td>안전통신입력 63</td></tr>
</tbody>
...
<tbody>
	<tr>
		<td>SB159</td>
		<td>축정보 선택</td>
		<td>1 = 현재위치(축각도), 2 = 현재위치(베이스좌표), 3 = 현재위치(베이스좌표/User좌표)<br>
			6 = 축속도, 7 = 모터속도 <br>
